...
use IKNSA\BlogBundle\Entity\Articles;
...
class ArticlesController extends Controller
{
    ...
    public function indexAction()
    {
        ...
        $articles = $em->getRepository('IKNSABlogBundle:Articles')->findAll();
    ...
    {
        $deleteForm = $this->createDeleteForm($article);
        $editForm = $this->createForm('IKNSA\BlogBundle\Form\ArticlesType', $article);

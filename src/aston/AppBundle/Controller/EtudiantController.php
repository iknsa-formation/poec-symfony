...
use aston\AppBundle\Entity\Etudiant;
...
class EtudiantController extends Controller
{
    ...
    public function aboutAction()
    {
        ...
        return $this->render('etudiant/about.html.twig');
    ...
    public function indexAction()
    {
        ...
        $etudiants = $em->getRepository('astonAppBundle:Etudiant')->findAll();
    ...
    public function newAction(Request $request)
    {
        ...
        $form = $this->createForm('aston\AppBundle\Form\EtudiantType', $etudiant);
    ...
    {
        $deleteForm = $this->createDeleteForm($etudiant);
        $editForm = $this->createForm('aston\AppBundle\Form\EtudiantType', $etudiant);

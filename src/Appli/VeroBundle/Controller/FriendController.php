...
use Appli\VeroBundle\Entity\Friend;
...
class FriendController extends Controller
{
    ...
    public function indexAction()
    {
        ...
        $friends = $em->getRepository('AppliVeroBundle:Friend')->findAll();
    ...
    {
        $friend = new Friend();
        $form = $this->createForm('Appli\VeroBundle\Form\FriendType', $friend);
    ...
    {
        $deleteForm = $this->createDeleteForm($friend);
        $editForm = $this->createForm('Appli\VeroBundle\Form\FriendType', $friend);

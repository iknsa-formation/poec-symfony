...
class __TwigTemplate_88b670b993f57db273103f5a905145ff0e24aecc6b36d23bbd6a3a9e6f2551a2 extends Twig_Template
{
    ...
    {
        $__internal_ff877df8158d7b9b1c9a32eef3285ad0654133c2c9aed92ae402edb059f4cff5 = $this->env->getExtension("Symfony\\Bridge\\Twig\\Extension\\ProfilerExtension");
        $__internal_ff877df8158d7b9b1c9a32eef3285ad0654133c2c9aed92ae402edb059f4cff5->enter($__internal_ff877df8158d7b9b1c9a32eef3285ad0654133c2c9aed92ae402edb059f4cff5_prof = new Twig_Profiler_Profile($this->getTemplateName(), "template", "TwigBundle:Exception:exception.html.twig"));
    ...
    <div class=\"block-exception-detected clear-fix\">
        ...
        <div class=\"text-exception\">
            ...
            <h1>";
        // line 14
        echo $this->env->getExtension('Symfony\Bridge\Twig\Extension\CodeExtension')->formatFileFromText(nl2br(twig_escape_filter($this->env, twig_get_attribute($this->env, $this->getSourceContext(), (isset($context["exception"]) || array_key_exists("exception", $context) ? $context["exception"] : (function () { throw new Twig_Error_Runtime('Variable "exception" does not exist.', 14, $this->getSourceContext()); })()), "message", array()), "html", null, true)));
        echo "</h1>

            <div>
                <strong>";
        // line 17
        echo twig_escape_filter($this->env, (isset($context["status_code"]) || array_key_exists("status_code", $context) ? $context["status_code"] : (function () { throw new Twig_Error_Runtime('Variable "status_code" does not exist.', 17, $this->getSourceContext()); })()), "html", null, true);
        echo "</strong> ";
        echo twig_escape_filter($this->env, (isset($context["status_text"]) || array_key_exists("status_text", $context) ? $context["status_text"] : (function () { throw new Twig_Error_Runtime('Variable "status_text" does not exist.', 17, $this->getSourceContext()); })()), "html", null, true);
        echo " - ";
        echo $this->env->getExtension('Symfony\Bridge\Twig\Extension\CodeExtension')->abbrClass(twig_get_attribute($this->env, $this->getSourceContext(), (isset($context["exception"]) || array_key_exists("exception", $context) ? $context["exception"] : (function () { throw new Twig_Error_Runtime('Variable "exception" does not exist.', 17, $this->getSourceContext()); })()), "class", array()));
        echo "
            </div>

            ";
        // line 20
        $context["previous_count"] = twig_length_filter($this->env, twig_get_attribute($this->env, $this->getSourceContext(), (isset($context["exception"]) || array_key_exists("exception", $context) ? $context["exception"] : (function () { throw new Twig_Error_Runtime('Variable "exception" does not exist.', 20, $this->getSourceContext()); })()), "allPrevious", array()));
        // line 21
        echo "            ";
        if ((isset($context["previous_count"]) || array_key_exists("previous_count", $context) ? $context["previous_count"] : (function () { throw new Twig_Error_Runtime('Variable "previous_count" does not exist.', 21, $this->getSourceContext()); })())) {
            // line 22
            echo "                <div class=\"linked\"><span><strong>";
            echo twig_escape_filter($this->env, (isset($context["previous_count"]) || array_key_exists("previous_count", $context) ? $context["previous_count"] : (function () { throw new Twig_Error_Runtime('Variable "previous_count" does not exist.', 22, $this->getSourceContext()); })()), "html", null, true);
            echo "</strong> linked Exception";
            echo ((((isset($context["previous_count"]) || array_key_exists("previous_count", $context) ? $context["previous_count"] : (function () { throw new Twig_Error_Runtime('Variable "previous_count" does not exist.', 22, $this->getSourceContext()); })()) > 1)) ? ("s") : (""));
            echo ":</span>
                    <ul>
                        ";
            // line 24
            $context['_parent'] = $context;
            $context['_seq'] = twig_ensure_traversable(twig_get_attribute($this->env, $this->getSourceContext(), (isset($context["exception"]) || array_key_exists("exception", $context) ? $context["exception"] : (function () { throw new Twig_Error_Runtime('Variable "exception" does not exist.', 24, $this->getSourceContext()); })()), "allPrevious", array()));
...
";
        // line 40
        $context['_parent'] = $context;
        $context['_seq'] = twig_ensure_traversable(twig_get_attribute($this->env, $this->getSourceContext(), (isset($context["exception"]) || array_key_exists("exception", $context) ? $context["exception"] : (function () { throw new Twig_Error_Runtime('Variable "exception" does not exist.', 40, $this->getSourceContext()); })()), "toarray", array()));
        foreach ($context['_seq'] as $context["position"] => $context["e"]) {
            // line 41
            echo "    ";
            $this->loadTemplate("@Twig/Exception/traces.html.twig", "TwigBundle:Exception:exception.html.twig", 41)->display(array("exception" => $context["e"], "position" => $context["position"], "count" => (isset($context["previous_count"]) || array_key_exists("previous_count", $context) ? $context["previous_count"] : (function () { throw new Twig_Error_Runtime('Variable "previous_count" does not exist.', 41, $this->getSourceContext()); })())));
        }
        $_parent = $context['_parent'];
...
";
        // line 44
        if ((isset($context["logger"]) || array_key_exists("logger", $context) ? $context["logger"] : (function () { throw new Twig_Error_Runtime('Variable "logger" does not exist.', 44, $this->getSourceContext()); })())) {
            // line 45
        ...
        <div class=\"logs clear-fix\">
            ...
            ";
            // line 57
            if (twig_get_attribute($this->env, $this->getSourceContext(), (isset($context["logger"]) || array_key_exists("logger", $context) ? $context["logger"] : (function () { throw new Twig_Error_Runtime('Variable "logger" does not exist.', 57, $this->getSourceContext()); })()), "counterrors", array())) {
                // line 58
                ...
                echo " error";
                echo (((twig_get_attribute($this->env, $this->getSourceContext(), (isset($context["logger"]) || array_key_exists("logger", $context) ? $context["logger"] : (function () { throw new Twig_Error_Runtime('Variable "logger" does not exist.', 60, $this->getSourceContext()); })()), "counterrors", array()) > 1)) ? ("s") : (""));
                echo "
                    </span>
                </div>
            ";
        ...
        <div id=\"logs\">
            ";
            // line 67
            $this->loadTemplate("@Twig/Exception/logs.html.twig", "TwigBundle:Exception:exception.html.twig", 67)->display(array("logs" => twig_get_attribute($this->env, $this->getSourceContext(), (isset($context["logger"]) || array_key_exists("logger", $context) ? $context["logger"] : (function () { throw new Twig_Error_Runtime('Variable "logger" does not exist.', 67, $this->getSourceContext()); })()), "logs", array())));
            // line 68
            echo "        </div>
    </div>
";
...
";
        // line 72
        if ((isset($context["currentContent"]) || array_key_exists("currentContent", $context) ? $context["currentContent"] : (function () { throw new Twig_Error_Runtime('Variable "currentContent" does not exist.', 72, $this->getSourceContext()); })())) {
            // line 73
            echo "    <div class=\"block\">
        ";
            // line 74
        ...
        <div id=\"output-content\" style=\"display: none\">
            ";
            // line 85
            echo twig_escape_filter($this->env, (isset($context["currentContent"]) || array_key_exists("currentContent", $context) ? $context["currentContent"] : (function () { throw new Twig_Error_Runtime('Variable "currentContent" does not exist.', 85, $this->getSourceContext()); })()), "html", null, true);
            echo "
        </div>
...
";
        // line 92
        $this->loadTemplate("@Twig/Exception/traces_text.html.twig", "TwigBundle:Exception:exception.html.twig", 92)->display(array("exception" => (isset($context["exception"]) || array_key_exists("exception", $context) ? $context["exception"] : (function () { throw new Twig_Error_Runtime('Variable "exception" does not exist.', 92, $this->getSourceContext()); })())));
        // line 93
        echo "
...
";
        ...
        $__internal_ff877df8158d7b9b1c9a32eef3285ad0654133c2c9aed92ae402edb059f4cff5->leave($__internal_ff877df8158d7b9b1c9a32eef3285ad0654133c2c9aed92ae402edb059f4cff5_prof);
...
//]]></script>
", "TwigBundle:Exception:exception.html.twig", "/Applications/MAMP/htdocs/symfony3/vendor/symfony/symfony/src/Symfony/Bundle/TwigBundle/Resources/views/Exception/exception.html.twig");
    }
}

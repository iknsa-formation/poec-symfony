...
class appDevDebugProjectContainerUrlMatcher extends Symfony\Bundle\FrameworkBundle\Routing\RedirectableUrlMatcher
{
    ...
    public function match($pathinfo)
    {
        ...
        if (rtrim($pathinfo, '/') === '') {
            if (substr($pathinfo, -1) !== '/') {
                return $this->redirect($pathinfo.'/', 'iknsa_app_homepage');
            }

            return array (  '_controller' => 'IKNSA\\AppBundle\\Controller\\DefaultController::indexAction',  '_route' => 'iknsa_app_homepage',);
        }

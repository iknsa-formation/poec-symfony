...
class appDevDebugProjectContainer extends Container
{
    ...
    {
        $this->services['cache.app'] = $instance = new \Symfony\Component\Cache\Adapter\FilesystemAdapter('XmdfIVOVsA', 0, (__DIR__.'/pools'));
    ...
    {
        return $this->services['cache.system'] = \Symfony\Component\Cache\Adapter\AbstractAdapter::createSystemCache('w5sHMuqFvF', 0, 'Qb2SE4KwRqY8BX-3weQWdV', (__DIR__.'/pools'), $this->get('monolog.logger.cache', ContainerInterface::NULL_ON_INVALID_REFERENCE));
    }
    ...
    protected function getCacheClearerService()
    {
        ...
        $b->addPool(\Symfony\Component\Cache\Adapter\AbstractAdapter::createSystemCache('y+7aoa2o8f', 0, 'Qb2SE4KwRqY8BX-3weQWdV', (__DIR__.'/pools'), $a));
        $b->addPool(\Symfony\Component\Cache\Adapter\AbstractAdapter::createSystemCache('CvD7e6IvAQ', 0, 'Qb2SE4KwRqY8BX-3weQWdV', (__DIR__.'/pools'), $a));
    ...
    protected function getDoctrine_Dbal_DefaultConnectionService()
    {
        ...
        return $this->services['doctrine.dbal.default_connection'] = $this->get('doctrine.dbal.connection_factory')->createConnection(array('driver' => 'pdo_mysql', 'host' => '127.0.0.1', 'port' => 8889, 'dbname' => 'symfony-moussa', 'user' => 'root', 'password' => 'root', 'charset' => 'UTF8', 'driverOptions' => array(), 'defaultTableOptions' => array()), $b, $c, array());
    }
    ...
    protected function getDoctrine_Orm_DefaultEntityManagerService($lazyLoad = true)
    {
        ...
        $a->addDriver(new \Doctrine\ORM\Mapping\Driver\AnnotationDriver($this->get('annotation_reader'), array(0 => ($this->targetDirs[3].'/src/intro/CrudBundle/Entity'))), 'intro\\CrudBundle\\Entity');

        $b = new \Doctrine\ORM\Configuration();
        $b->setEntityNamespaces(array('introCrudBundle' => 'intro\\CrudBundle\\Entity'));
    ...
    protected function getDoctrineCache_Providers_Doctrine_Orm_DefaultMetadataCacheService()
    {
        ...
        $instance->setNamespace('sf_orm_default_ecfee18be0c3635dcca41b4c60b2148e27a40b6a270ff6a1813c959d6940e18b');
    ...
    protected function getTwig_LoaderService()
    {
        ...
        $instance->addPath(($this->targetDirs[3].'/src/intro/CrudBundle/Resources/views'), 'introCrud');
        $instance->addPath(($this->targetDirs[3].'/src/IKNSA/AppBundle/Resources/views'), 'IKNSAApp');
    ...
    {
        $this->services['security.authentication.manager'] = $instance = new \Symfony\Component\Security\Core\Authentication\AuthenticationProviderManager(array(0 => new \Symfony\Component\Security\Core\Authentication\Provider\AnonymousAuthenticationProvider('5a26bed04f1456.60742768')), true);
    ...
    protected function getDefaultParameters()
    {
        return array(
            ...
            'kernel.bundles' => array(
                ...
                'introCrudBundle' => 'intro\\CrudBundle\\introCrudBundle',
                'IKNSAAppBundle' => 'IKNSA\\AppBundle\\IKNSAAppBundle',
            ...
            'kernel.bundles_metadata' => array(
                ...
                'introCrudBundle' => array(
                    'parent' => NULL,
                    'path' => ($this->targetDirs[3].'/src/intro/CrudBundle'),
                    'namespace' => 'intro\\CrudBundle',
                ),
                'IKNSAAppBundle' => array(
                    'parent' => NULL,
                    'path' => ($this->targetDirs[3].'/src/IKNSA/AppBundle'),
                    'namespace' => 'IKNSA\\AppBundle',
                ),
                'DebugBundle' => array(
                    'parent' => NULL,

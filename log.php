        ...
        <div class="col-md-12">
        	<form class="log" method="POST" action="display1.php">
        	   <div class="table-responsive">
                  <table class="table table-bordered table-striped" border = 1 style="width: 50%; height: 80px">
                	   <tbody>
                		 <tr>
                		 <td>
                			<label class="details" for="firstname" style="padding-left: 130px">FirstName*</label>
                      <center><input type="text" id="firstname" name="firstname" placeholder="Prenom"/></center>
                     </td>
                		 </tr>
                		 <tr>
                		 <td>
                			<label for="lastname" style="padding-left: 130px">LastName</label>
                      <center><input type="text" id="lastname" name="lastname" placeholder="Nom"/></center>
                     </td>
                		 </tr>
                		 <tr>
                		 <td>
                			<label for="address" style="padding-left: 130px">Address</label>
                      <center><input type="text" id="address" name="address" placeholder="Adress"/></center>
                     </td>
                		 </tr>
                		 <tr>
                		 <td>
                			<label for="profession" style="padding-left: 130px">Profession</label>
                      <center><input type="text" id="profession" name="profession" placeholder="Poste"/></center>
                     </td>
                		 </tr>
                		 <tr>
                		 <td>

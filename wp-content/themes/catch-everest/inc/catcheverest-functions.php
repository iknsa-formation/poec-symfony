			...
			<section class="featured-slider">
				<article class="post hentry slides displayblock">
					...
					<div class="entry-container">
						<header class="entry-header">
							<h2 class="entry-title">
								<a title="Mountgtfygtfytrytrytrytrytr Everest" href="#"><span>Mount Everest</span></a>
							</h2>
						</header>
			...
			<section id="featured-post" class="' . $classes . '">
				<article class="post hentry first">
					<figure class="featured-homepage-image">
						<a href="#" title="Sierra Norte de Puebla">
							<img title="Géomorphologie" alt="Nepal Prayer Wheels" class="wp-post-image" src="'.get_template_directory_uri() . '/images/thumb-390-1.jpg" />
						</a>
					</figure>
					<div class="entry-container">
						<header class="entry-header">

    ...
    $wp_customize->add_control(
		new Blossom_Feminine_Radio_Image_Control(
			...
			array(
				...
				'description' => __( 'This is the general sidebar layout for pages. You can override the sidebar layout for individual page in repective page.', 'blossom-feminine' ),
				'choices'	  => array(
    ...
    $wp_customize->add_control(
		new Blossom_Feminine_Radio_Image_Control(
			...
			array(
				...
				'description' => __( 'This is the general sidebar layout for posts. You can override the sidebar layout for individual post in repective post.', 'blossom-feminine' ),
				'choices'	  => array(
					'no-sidebar'    => get_template_directory_uri() . '/images/1c.png',
					'left-sidebar'  => get_template_directory_uri() . '/images/2cl.png',
                    'right-sidebar' => get_template_directory_uri() . '/images/2cr.png',
    ...
    if( blossom_feminine_is_btif_activated() ){
        ...
        $wp_customize->add_control(
            new Blossom_Feminine_Note_Control( 
    			...
    			array(
    				'section'	  => 'instagram_settings',
    				'description' => sprintf( __( 'You can change the setting BlossomThemes Instagram Feed %1$sfrom here%2$s.', 'blossom-feminine' ), '<a href="' . admin_url( 'admin.php?page=class-blossomthemes-instagram-feed-admin.php' ) . '" target="_blank">', '</a>' )
    			)
    		)
        );        
    }else{
        ...
        $wp_customize->add_control(
            new Blossom_Feminine_Note_Control( 
    			...
    			array(
    				'section'	  => 'instagram_settings',
    				'description' => sprintf( __( 'Please install and activate the recommended plugin %1$sBlossomThemes Instagram Feed%2$s. After that option related with this section will be visible.', 'blossom-feminine' ), '<a href="' . admin_url( 'themes.php?page=tgmpa-install-plugins' ) . '" target="_blank">', '</a>' )
    			)
    		)
        );
    }

...
function blossom_feminine_header(){ 
    ...
    <header id="masthead" class="site-header wow fadeIn" data-wow-delay="0.1s">
		...
		<div class="header-b">
			<div class="container">
				<div id="primary-toggle-button"><i class="fa fa-bars"></i><?php esc_html_e( 'Navigation', 'blossom-feminine' ); ?></div>
...
function blossom_feminine_breadcrumb(){    
    ...
    if( get_theme_mod( 'ed_breadcrumb', true ) && ! is_front_page() && ! is_search() ){
        ...
        if( is_home() ){
            ...
            echo $before . esc_html__( 'Search Results for "', 'blossom-feminine' ) . esc_html( get_search_query() ) . esc_html__( '"', 'blossom-feminine' ) . $after;
        
        }elseif( is_day() ){
            
            echo '<a href="' . esc_url( get_year_link( get_the_time( __( 'Y', 'blossom-feminine' ) ) ) ) . '">' . esc_html( get_the_time( __( 'Y', 'blossom-feminine' ) ) ) . '</a> <span class="separator">' . esc_html( $delimiter ) . '</span> ';
            echo '<a href="' . esc_url( get_month_link( get_the_time( __( 'Y', 'blossom-feminine' ) ), get_the_time( __( 'm', 'blossom-feminine' ) ) ) ) . '">' . esc_html( get_the_time( __( 'F', 'blossom-feminine' ) ) ) . '</a> <span class="separator">' . esc_html( $delimiter ) . '</span> ';
            echo $before . esc_html( get_the_time( __( 'd', 'blossom-feminine' ) ) ) . $after;
        
        }elseif( is_month() ){
            
            echo '<a href="' . esc_url( get_year_link( get_the_time( __( 'Y', 'blossom-feminine' ) ) ) ) . '">' . esc_html( get_the_time( __( 'Y', 'blossom-feminine' ) ) ) . '</a> <span class="separator">' . esc_html( $delimiter ) . '</span> ';
            echo $before . esc_html( get_the_time( __( 'F', 'blossom-feminine' ) ) ) . $after;
        
        }elseif( is_year() ){
            
            echo $before . esc_html( get_the_time( __( 'Y', 'blossom-feminine' ) ) ) . $after;
            ...
            if( get_query_var('paged') ){
                ...
                echo ' <span class="separator">' . esc_html( $delimiter ) . '</span> ' . $before . sprintf( __('Page %s', 'blossom-feminine'), get_query_var('paged') ) . $after;
            }else{
...
function blossom_feminine_content_start(){
    ...
    <div class="container main-content">
         ...
         * Page Header
         * 
         * @hooked blossom_feminine_page_header
        */
        				...
        				<a href="<?php the_permalink(); ?>" class="img-holder">
        					<?php 
                                if( has_post_thumbnail() ){
                                    ...
                                    <img src="<?php echo esc_url( get_template_directory_uri() . '/images/no-img_450_300.png' ); ?>" alt="<?php the_title_attribute(); ?>" />
                                <?php
                                }
...
function blossom_feminine_post_thumbnail(){ 
    ...
    if( is_home() ){        
        ...
        if( has_post_thumbnail() ){
            ...
            $image_size = is_sticky() ? '/images/no-img_1410_600.png' : '/images/no-img_435_435.png';
            echo '<img src="' . esc_url( get_template_directory_uri() . $image_size  ) . '" alt="' . esc_attr( get_the_title() ) . '" />';    
        }        
        echo '</a></div>';
        ...
        if( has_post_thumbnail() ){
            ...
            echo '<img src="' . esc_url( get_template_directory_uri() . '/images/no-img_450_300.png'  ) . '" alt="' . esc_attr( get_the_title() ) . '" />';
        }
        echo '</a>';
    }elseif( is_singular() ){
...
function blossom_feminine_entry_header(){ ?>
    ...
    <?php 
        ...
        if( is_single() ){
            if( ! $ed_cat_single ) blossom_feminine_categories();
        }else{
            blossom_feminine_categories();
        }
        /**
        ...
        */
		...
		if ( 'post' === get_post_type() ){ 
            ...
            if( is_single() ){
                if( ! $ed_post_date ) blossom_feminine_posted_on();
            }else{
        				...
        				<div class="img-holder">
                            ...
                            <?php
                                if( has_post_thumbnail() ){
                                    ...
                                    <img src="<?php echo esc_url( get_template_directory_uri() . '/images/no-img_320_200.png' ); ?>" alt="<?php the_title_attribute(); ?>" />
                                <?php 
                                }
                            ?>
                            </a>
    ...
    <div class="site-info">
		<div class="container">
			<?php
                ...
                echo '<a href="' . esc_url( 'https://blossomthemes.com/themes/blossom-feminine-free-wordpress-theme' ) .'" rel="author" target="_blank">' . esc_html__( ' Blossom Feminine', 'blossom-feminine' ) . '</a>' . esc_html__( ' by Blossom Themes.', 'blossom-feminine' );
